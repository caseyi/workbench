...
- [ ] **Resolve Jira workflow open decisions + Phase 2 admin setup** - proposal doc done; 3 unresolved decisions, then create Acceptance status, Reject Count field, automation rule, filters #jira @jira-admin (from: Jira statuses) (touched: 2026-06-12)
