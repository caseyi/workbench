...
- [x] **Schedule OGC-361 into ENV S2 (dropped)** - subtask to story conversion abandoned (Jira would not convert); OGC-361 confirmed parented to epic OGC-527 (Vector — Env and Vector Testing Module), which satisfies the requirement #jira @vector @jira-admin (from: PNG work plan) (done: 2026-06-15)
